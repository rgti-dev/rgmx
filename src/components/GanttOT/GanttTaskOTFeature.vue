      ...
      <div v-for="(subtask, index) in sortedSubtasks" :key="subtask.id" class="subtask-row">
        ...
        <div class="flex-1 h-full relative">
          <template v-if="subtask.name.toUpperCase() === 'KICK OFF'">
            ...
            <div class="milestone expanded-kickoff" 
                 :style="getExpandedKickoffStyle(subtask, task)"
                 @mouseenter="showTooltip(subtask, $event)" 
                 @mouseleave="hideTooltip">
              <div class="milestone-label absolute whitespace-nowrap text-xs font-medium"
                   :style="{ top: '20px', left: '15px', color: subtask.color || task.color }">
          ...
          <template v-else>
            ...
            <div class="subtask-expanded-bar absolute" :style="getSubtaskExpandedStyle(subtask, task)">
              ...
              <div class="subtask-abbreviation"
                style="position: absolute; left: 4px; top: 2px; font-size: 10px; font-weight: bold; color: white;">
