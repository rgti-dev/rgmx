...
/**
 * Función que genera y descarga un PDF con la carta responsiva
 * utilizando los datos del objeto 'equipo'.
 *
 * @param {Object} equipo - Objeto con los datos del equipo.
 */
export function generatePDF(equipo) {
  const doc = new jsPDF();

  // Establece la fuente Cambria para todo el documento.
  // IMPORTANTE: Asegúrate de haber cargado previamente la fuente Cambria (normal y bold).
  ...
  img.onload = function () {
    ...
    // Se mueve dos filas (lineHeight de 7 * 2 = 14 unidades) más abajo respecto a la posición original.
    ...
    // Imprime el 'boldPrefix' en negrita y, en la misma línea, el resto del texto en fuente normal.
    ...
    // Los primeros 3 se imprimen con "Me comprometo" en negrita y el resto en fuente normal.
    // Los dos últimos se imprimen en fuente normal.
